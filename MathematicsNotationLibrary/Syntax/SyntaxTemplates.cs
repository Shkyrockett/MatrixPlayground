...
namespace MathematicsNotationLibrary
{
    ...
    public static class SyntaxTemplates
    {
        ...
        {
            var values1 = matrix1.Coefficients;
            var values2 = Operations.Inverse(matrix2.Coefficients);
            var values3 = Operations.Multiply(values1, values2);
        ...
        public static RelationalOperation SquareEquationFactory(NumericMatrixFactor matrix, out NumericMatrixFactor matrixResult)
        {
            ...
            var values2 = Operations.Multiply(values1, values1);
        ...
        {
            var values1 = matrix.Coefficients;
            var values2 = Operations.Multiply(Operations.Multiply(values1, values1), values1);
        ...
        {
            var values1 = matrix.Coefficients;
            var values2 = Operations.Inverse(values1);
        ...
        {
            var values1 = matrix.Coefficients;
            var values2 = Operations.RotateMatrixClockwise(values1);
        ...
        {
            var values1 = matrix.Coefficients;
            var values2 = Operations.RotateMatrixCounterClockwise(values1);
            var squareMatrix = new NumericMatrixFactor(matrix, new VariableFactor('R', 1), null);
        ...
        {
            var values1 = matrix.Coefficients;
            var values2 = Operations.Transpose(values1);
