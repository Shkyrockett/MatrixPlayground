...
public struct LinearRegression
{
    ...
    public double[,] RegressionMatrix()
    {
        ...
        return Operations.ConcatenationColumns<double>(vectConst, explanatoryMatrix);
    }
    ...
    public double[,] RegressorsMCO()
    {
        ...
        var beta = Operations.Multiply<double>(Operations.Multiply<double>(Operations.Inverse<double>(Operations.Multiply<double>(Operations.Transpose<double>(R), R)), Operations.Transpose<double>(R)), responseVariable);
        return beta;
    }

    /// <summary>
    /// Predictions for this instance.
    /// </summary>
    /// <returns></returns>
    /// <acknowledgment>
    /// https://github.com/SarahFrem/AutoRegressive_model_cs/blob/master/RegressionLineaire.cs
    /// </acknowledgment>
    public double[,] Predictions() => Operations.Multiply<double>(RegressionMatrix(), RegressorsMCO());
    ...
    /// https://github.com/SarahFrem/AutoRegressive_model_cs/blob/master/RegressionLineaire.cs
    /// </acknowledgment>
    public double[,] Errors() => Operations.Subtract<double, double>(responseVariable, Predictions());
    ...
    {
        var E = Errors();
        var var = Operations.Multiply<double>(Operations.Transpose<double>(E), E);
    ...
    public double[,] VarianceCovarianceBeta()
    {
        ...
        var res = Operations.Inverse<double>(Operations.Multiply<double>(Operations.Transpose<double>(R), R));
