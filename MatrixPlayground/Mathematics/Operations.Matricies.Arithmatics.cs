...
namespace MatrixPlayground
{
    ...
    public static partial class Operations
    {
        ...
        public static float[,] Plus(float[,] augend)
        {
            if (augend is null)
            {
                return augend;
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float[,] Negate(float[,] augend)
        {
            var rows = augend.GetLength(0);
            var cols = augend.GetLength(1);
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float[,] Scale(float multiplicand, float[,] multiplier)
        {
            var multiplicandRows = multiplier.GetLength(0);
            var multiplicandCols = multiplier.GetLength(1);

            var result = new float[multiplicandRows, multiplicandCols];
        ...
        public static float[] Multiply(float[,] multiplicand, float[] multiplier)
        {
            ...
            var result = new float[multiplicandRows];
            for (var i = 0; i < multiplicandRows; i++)
            {
        ...
        public static float[] Multiply(float[] multiplicand, float[,] multiplier)
        {
            ...
            var result = new float[multiplicandCols];
            for (var i = 0; i < multiplicandRows; i++)
            {
                for (var j = 0; j < multiplierCols; j++)
                {
        ...
        public static float[,] Multiply(float[,] multiplicand, float[,] multiplier)
        {
            ...
            var result = new float[multiplicandRows, multiplierCols];
            for (var i = 0; i < multiplicandRows; i++)
            {
                for (var j = 0; j < multiplierCols; j++)
                {
